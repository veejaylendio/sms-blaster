  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        <h1 className="text-3xl font-bold tracking-tight text-foreground text-glow mb-2">New Life - Iligan</h1>
        <p className="text-text-muted text-sm">Sign in to your NexusCore account</p>
      </div>
